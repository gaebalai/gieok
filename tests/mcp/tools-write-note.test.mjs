// tools-write-note.test.mjs — gieok_write_note 핸들러의 단위 테스트
...
before(async () => {
  workspace = await mkdtemp(join(tmpdir(), 'gieok-mcp-wn-'));
...
describe('gieok_write_note', () => {
  ...
  test('MCP15c accepts Chinese / Japanese titles', async () => {
