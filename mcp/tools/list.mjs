// gieok_list — Wiki 디렉터리 트리를 반환한다.
// .obsidian/ .archive/ .trash/ templates/ 를 제외, 깊이·건수를 상한으로 클램프.
...
export const LIST_TOOL_DEF = {
  name: 'gieok_list',
  title: 'List GIEOK wiki tree',
  description:
    'List Markdown pages and directories under the GIEOK wiki. Returns at most 1000 entries; depth defaults to 3 (max 5).',
  inputShape: {
    subdir: z
      .string()
      .max(256)
